  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center bg-bg">
      ...
      <p className="text-[14px] text-ink3 leading-relaxed mb-6 max-w-[280px]">
        Your money is safe. This is just a display glitch — tap below to try again.
      </p>
      <button
        onClick={reset}
        className="rounded-button bg-primary text-white font-semibold text-[15px] px-8 py-3.5"
      >
        Try again
      </button>
    </div>
